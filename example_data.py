...
from characteristics.characteristics import plot_fft

size = 1000
seed = 41
# config = {"repeating": {"period": 10}, "noise": {"std_dev": 0.1}}
...
# config = {"logistic": {"max_capacity": 1,"growth": 6,"midpoint": 800}}
...
config = {
    "logistic": {"max_capacity": 1,"growth": 1,"midpoint": 500}, 
    "multi_sinusoidal": {"num_sin": 2, "min_value": 0, "max_value": 0.4},
    "trend": {"max_return": 0.03, "trend": 0.1, "min_value":0, "max_value": 0.6},
    "noise": {"std_dev": 0.01}
}
...
# config = {"fetch_stock_data": {"symbol": "XWD.TO", "data_type": "Close", "interval": "1d", "start_date": "2016-07-01"}}
...
# config = {"uci_electricity": {"start": 20000, "name": "Global_active_power"}} # 'Global_active_power', 'Global_reactive_power', 'Voltage', 'Global_intensity', 'Sub_metering_1', 'Sub_metering_2', 'Sub_metering_3'
