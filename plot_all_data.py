...
double_plot_linear_regressions(results, f"{csv_name}_regressions",  [dnn_categories, cnn_categories, lstm_categories, method_categories, metric_categories], path="all_results")
