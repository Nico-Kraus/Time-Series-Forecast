...
results = results.rename(columns={"spectral_entropy_psd": "spectral_entropy"})
results = results.rename(columns={"spectral_entropy_fft": "fourier_entropy"})
...
characteristics_e = ["sample_entropy", "perm_entropy", "spectral_entropy", "fourier_entropy"]
